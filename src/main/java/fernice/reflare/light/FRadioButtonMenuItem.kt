...
import org.fernice.reflare.ui.FlareRadioButtonMenuItemUI
...
@Suppress("UNUSED")
open class FRadioButtonMenuItem : JRadioButtonMenuItem {
    ...
    override fun updateUI() {
        super.setUI(integrationDependent(this) { FlareRadioButtonMenuItemUI() })
    }
