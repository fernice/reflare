...
public class FlareCheckBoxMenuItemUI extends BasicCheckBoxMenuItemUI implements FlareUI {

    @DefinedBy(Api.LOOK_AND_FEEL)
    public static ComponentUI createUI(JComponent c) {
        return new FlareCheckBoxMenuItemUI();
    }
    ...
    private static final class FlareCheckBoxMenuItemIcon implements Icon, UIResource {

        private final Icon icon = StyledImageIcon.fromResource("/reflare/icons/check-box-menu-item.png");
