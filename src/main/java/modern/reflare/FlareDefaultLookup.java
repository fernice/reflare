...
import modern.reflare.ui.FlareUI;
...
public class FlareDefaultLookup extends DefaultLookup {

    @Override
    public Object getDefault(final JComponent component, final ComponentUI ui, final String key) {
        ...
        return super.getDefault(component, ui, key);
    }
